...
const Footer = ({ isDarkMode }) => {
    ...
    return (
        <footer
            ...
            } border-t border-b border-purple-700 border-opacity-65 shadow-xl xl:pr-10`}
        >
            <div className="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
                <span
                    className={`text-sm ${
                        isDarkMode ? 'text-gray-400' : 'text-gray-500'
                    } sm:text-center block mb-3`}
                >
                    © {currentYear} <a href="" className="hover:underline">EreyomiF</a>. Made with 💜 .
                </span>
                <ul
                    className={`flex flex-wrap justify-center items-center mt-3 text-sm font-medium ${
                        isDarkMode ? 'text-gray-400' : 'text-gray-500'
                    } sm:mt-0`}
                >
                    <li>
