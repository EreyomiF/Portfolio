    ...
    <div className="flex space-x-3 ">
      {icons.map((icon, index) => (
        <div
          ...
          className={`w-5 h-5 ${hovered !== null && hovered !== index ? 'text-gray-500' : 'text-white'}`}
        >
          {icon}
        </div>
      ))}
