      ...
      <div id="timeline" className="timeline">
        ...
        />
         <TimelineItem
          ...
          subtitle="Front-end developer"
          //description={`Developed and maintained the dashboard interface for Trocah Technology's mobile application.\nImplemented user-friendly and responsive designs to enhance the accessibility and functionality of the dashboard.\nImplemented new features that contributed to increased efficiency in currency exchange transactions.\nPlayed a key role in enhancing the app's overall user experience, resulting in positive feedback from users and stakeholders.\nImplemented real-time data visualization features to display currency exchange rates and trends.\nContributed to feature enhancements and updates based on user feedback and market trends.\nConducted testing and debugging to optimize performance and ensure a smooth user experience.`}
        />
